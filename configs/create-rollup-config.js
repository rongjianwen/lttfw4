...
function createRollupConfig(options) {
    const { projectDir, distDir, inputFilename, outputFilename, libname, format, useDefaultExternals } = options;
    ...
    return {
        input: path.resolve(projectDir, inputFilename || './src/index.ts'),
        output: {
            file: path.resolve(distDir, `${outputFilename}.js`),
            format,
            name: libname,
            sourcemap: true
        },
