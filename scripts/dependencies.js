const dependencies = [
    ...
    },
    {
        files: [
            {
                url: 'https://unpkg.com/reduxjs-toolkit-persist@7.0.7/dist/reduxjs-toolkit-persist.min.js',
                output: 'reduxjs-toolkit-persist@7.0.7.min.js'
            }
        ],
        destDir: 'reduxjs-toolkit-persist'
    }
];
